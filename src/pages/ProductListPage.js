...
export default function ProductListPage() {
    ...
    // catch category param from url (from slider)
    useEffect(() => {
    ...
    const toggleResetPagination = () => setPage(1); // call this when filters change if desired
            ...
            <div className="plp-inner">
                ...
                <aside className="plp-sidebar">
                    ...
                    <details className="filter-block">
                        ...
                        <div className="filter-content">
                            <input type="range" min="0" max="150000" step="1000" value={priceRange}
                ...
                <main className="plp-main">
                    ...
                    <div className="plp-topbar">
                        <div className="breadcrumbs">
                            {breadcrumbs.map((b, i) => <span key={i} className={i === breadcrumbs.length - 1 ? "crumb active" : "crumb"}>{b}{i < breadcrumbs.length - 1 && " › "}</span>)}
                        </div>
                        ...
                        <div className="sortbar">
                            ...
                            <div className="results-count">{sorted.length ?? filtered.length} results</div>
                        </div>
                    </div>
                        ...
                        {paged.length ? paged.map(p => (
                            <article key={p.id} className="product-card">
                                <div className="card-media">
                                    <img src={p.image} alt={p.name} onError={(e) => e.target.src = "https://via.placeholder.com/300x200?text=No+Image"} />
